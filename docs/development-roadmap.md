...
| 优先级 | 功能 | 理由 |
|---|---|---|
| 1 | 14. 应用内日志 | 实用功能，纯 UI + 文件读取，无技术难点 |
| 2 | 2. 文件列表树 | 核心 API 已就绪，同步逻辑已稳定，主要是 UI 工作 |
| 3 | 3. 主题扩展 | 独立功能，不影响核心流程，提升使用体验 |
| 4 | 13. 图片压缩 | 实用功能，需引入 image 包，改造上传流程 |
| 5 | 12. 友链管理 | 独立功能，需自定义 YAML 解析，UI 复用现有模式 |
