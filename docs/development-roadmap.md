...
| 优先级 | 功能 | 理由 |
|---|---|---|
| 1 | 11. 开发者信息 | 纯 UI 硬编码，工作量极小 |
| 2 | 9. 检查更新 | 改动小，用户体验提升明显 |
| 3 | 10. 反馈入口 | 纯 UI 跳转，工作量极小 |
| 4 | 2. 文件列表树 | 核心 API 已就绪，同步逻辑已稳定，主要是 UI 工作 |
| 5 | 3. 主题扩展 | 独立功能，不影响核心流程，提升使用体验 |
| 6 | 6. 网易云播放器 | 锦上添花，依赖外部 API 稳定性 |
